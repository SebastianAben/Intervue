...
runner_dir="${RUNNER_DIR:-/home/froztbitez/actions-runner-intervue}"
repo_url="${REPO_URL:-https://github.com/SebastianAben/Intervue}"
runner_name="${RUNNER_NAME:-intervue-home}"
runner_labels="${RUNNER_LABELS:-intervue-home}"
...
systemctl status "actions.runner.SebastianAben-Intervue.${runner_name}.service" --no-pager
